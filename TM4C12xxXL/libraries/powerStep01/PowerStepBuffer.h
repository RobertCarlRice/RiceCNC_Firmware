...
#ifndef PowerStepBuffer_h
#define PowerStepBuffer_h
...
typedef void (PowerStepAxis::*PowerStepAxisCallback)( uint32_t );  

class PowerStepBuffer : public SsiBuffer {
	private:
    PowerStepAxis*			target;
    PowerStepAxisCallback	callBack;
